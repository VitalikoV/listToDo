...
public class PostgresQLList extends Additional implements DatabaseList {
...
//        props.setProperty("password","");
         connection = DriverManager.getConnection("jdbc:postgresql://localhost:5432/todolist");
    ...
    public void createTable() throws SQLException {
        PreparedStatement preparedStatement = connection.prepareStatement("CREATE table if not exists tasks(id SERIAL PRIMARY KEY, name varchar(250) , task varchar(250), start_at TIME, end_at TIME);");
    ...
    public void getToDoFromConsole(Connection connection) throws SQLException {
        ...
        if (isCommandExist(command, SELECT_ALL)){
            selectAll();
        ...
        }else if (isCommandExist(command, CREATE_TABLE)){
            createTable();
